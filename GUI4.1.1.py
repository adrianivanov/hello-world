...
class Ui_MainWindow(object):
    ...
    def pressed_neural(self):
        ...
        pickle_aer = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\neural_aer.pickle', 'rb')
        ...
        pickle_pres = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\neural_pres.pickle', 'rb')
        ...
        pickle_h2s = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\neural_h2s.pickle', 'rb')
        ...
        pickle_so2 = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\neural_so2.pickle', 'rb')
        ...
        pickle_s1 = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\neural_s1.pickle', 'rb')
        ...
        pickle_soba = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\neural_soba.pickle', 'rb')
        ...
        pickle_scor = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\li_neural.pickle', 'rb')
    ...
    def pressed_linear(self):
        ...
        pickle_aer = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\linear_aer.pickle', 'rb')
        bacon_aer = pickle.load(pickle_aer)
        predictie_aer = bacon_aer.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        aer_unsc = sc_y_aer.inverse_transform(predictie_aer)
        self.aer.setText(str(aer_unsc))
        
        pickle_pres = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\linear_pres.pickle', 'rb')
        bacon_pres = pickle.load(pickle_pres)
        predictie_pres = bacon_pres.predict(sc_y_aer.transform(np.array(aer_unsc)))
        self.presiune.setText(str(predictie_pres))
        
        pickle_h2s = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\linear_h2s.pickle', 'rb')
        bacon_h2s = pickle.load(pickle_h2s)
        predictie_h2s = bacon_h2s.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        h2s_unsc = sc_h2s.inverse_transform(predictie_h2s)
        self.anH2S.setText(str(h2s_unsc))
        
        pickle_so2 = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\linear_so2.pickle', 'rb')
        bacon_so2 = pickle.load(pickle_so2)
        predictie_so2 = bacon_so2.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        so2_unsc = sc_so2.inverse_transform(predictie_so2)
        self.anSO2.setText(str(so2_unsc))
        
        pickle_s1 = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\linear_s1.pickle', 'rb')
        bacon_s1 = pickle.load(pickle_s1)
        predictie_s1 = bacon_s1.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        s1_unsc = sc_s1.inverse_transform(predictie_s1)
        self.temps1.setText(str(s1_unsc))
        
        pickle_soba = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\linear_soba.pickle', 'rb')
        bacon_soba = pickle.load(pickle_soba)
        predictie_soba = bacon_soba.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        soba_unsc = sc_soba.inverse_transform(predictie_soba)
        self.tempsoba.setText(str(soba_unsc))
        
        pickle_scor = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\li_linear.pickle', 'rb')
        bacon_scor = pickle.load(pickle_scor)
        a, b, c, d, e, f = bacon_scor
        self.scoraer.setText(str(a))
        self.scorpres.setText(str(b))
    ...
    def pressed_tree(self):
        ...
        pickle_aer = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\tree_aer.pickle', 'rb')
        bacon_aer = pickle.load(pickle_aer)
        predictie_aer = bacon_aer.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        aer_unsc = sc_y_aer.inverse_transform(predictie_aer)
        self.aer.setText(str(aer_unsc))
        
        pickle_pres = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\tree_pres.pickle', 'rb')
        bacon_pres = pickle.load(pickle_pres)
        predictie_pres = bacon_pres.predict(sc_y_aer.transform(np.array([aer_unsc])))
        self.presiune.setText(str(predictie_pres))
        
        pickle_h2s = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\tree_h2s.pickle', 'rb')
        bacon_h2s = pickle.load(pickle_h2s)
        predictie_h2s = bacon_h2s.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        h2s_unsc = sc_h2s.inverse_transform(predictie_h2s)
        self.anH2S.setText(str(h2s_unsc))
        
        pickle_so2 = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\tree_so2.pickle', 'rb')
        bacon_so2 = pickle.load(pickle_so2)
        predictie_so2 = bacon_so2.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        so2_unsc = sc_so2.inverse_transform(predictie_so2)
        self.anSO2.setText(str(so2_unsc))
        
        pickle_s1 = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\tree_s1.pickle', 'rb')
        bacon_s1 = pickle.load(pickle_s1)
        predictie_s1 = bacon_s1.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        s1_unsc = sc_s1.inverse_transform(predictie_s1)
        self.temps1.setText(str(s1_unsc))
        
        pickle_soba = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\tree_soba.pickle', 'rb')
        bacon_soba = pickle.load(pickle_soba)
        predictie_soba = bacon_soba.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        soba_unsc = sc_soba.inverse_transform(predictie_soba)
        self.tempsoba.setText(str(soba_unsc))
                
        pickle_scor = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\li_tree.pickle', 'rb')
        bacon_scor = pickle.load(pickle_scor)
        a,b,c,d,e,f = bacon_scor
        self.scoraer.setText(str(a))
        self.scorpres.setText(str(b))
    ...
    def pressed_forest(self):
        ...
        pickle_aer = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\forest_aer.pickle', 'rb')
        bacon_aer = pickle.load(pickle_aer)
        predictie_aer = bacon_aer.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        aer_unsc = sc_y_aer.inverse_transform(predictie_aer)
        self.aer.setText(str(aer_unsc))
        
        pickle_pres = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\forest_pres.pickle', 'rb')
        bacon_pres = pickle.load(pickle_pres)
        predictie_pres = bacon_pres.predict(sc_y_aer.transform(np.array([aer_unsc])))
        self.presiune.setText(str(predictie_pres))
        
        pickle_h2s = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\forest_h2s.pickle', 'rb')
        bacon_h2s = pickle.load(pickle_h2s)
        predictie_h2s = bacon_h2s.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        h2s_unsc = sc_h2s.inverse_transform(predictie_h2s)
        self.anH2S.setText(str(h2s_unsc))
        
        pickle_so2 = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\forest_so2.pickle', 'rb')
        bacon_so2 = pickle.load(pickle_so2)
        predictie_so2 = bacon_so2.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        so2_unsc = sc_so2.inverse_transform(predictie_so2)
        self.anSO2.setText(str(so2_unsc))
        
        pickle_s1 = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\forest_s1.pickle', 'rb')
        bacon_s1 = pickle.load(pickle_s1)
        predictie_s1 = bacon_s1.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        s1_unsc = sc_s1.inverse_transform(predictie_s1)
        self.temps1.setText(str(s1_unsc))
        
        pickle_soba = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\forest_soba.pickle', 'rb')
        bacon_soba = pickle.load(pickle_soba)
        predictie_soba = bacon_soba.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        soba_unsc = sc_soba.inverse_transform(predictie_soba)
        self.tempsoba.setText(str(soba_unsc))
                
        pickle_scor = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\li_forest.pickle', 'rb')
        bacon_scor = pickle.load(pickle_scor)
        a,b,c,d,e,f = bacon_scor
        self.scoraer.setText(str(a))
        self.scorpres.setText(str(b))
    ...
    def pressed_svr(self):
        ...
        pickle_aer = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\svr_aer.pickle', 'rb')
        bacon_aer = pickle.load(pickle_aer)
        predictie_aer = bacon_aer.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        aer_unsc = sc_y_aer.inverse_transform(predictie_aer)
        self.aer.setText(str(aer_unsc))
        
        pickle_pres = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\svr_pres.pickle', 'rb')
        bacon_pres = pickle.load(pickle_pres)
        predictie_pres = bacon_pres.predict(sc_y_aer.transform(np.array([aer_unsc])))
        self.presiune.setText(str(predictie_pres))
        
        pickle_h2s = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\svr_h2s.pickle', 'rb')
        bacon_h2s = pickle.load(pickle_h2s)
        predictie_h2s = bacon_h2s.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        h2s_unsc = sc_h2s.inverse_transform(predictie_h2s)
        self.anH2S.setText(str(h2s_unsc))
        
        pickle_so2 = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\svr_so2.pickle', 'rb')
        bacon_so2 = pickle.load(pickle_so2)
        predictie_so2 = bacon_so2.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        so2_unsc = sc_so2.inverse_transform(predictie_so2)
        self.anSO2.setText(str(so2_unsc))
        
        pickle_s1 = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\svr_s1.pickle', 'rb')
        bacon_s1 = pickle.load(pickle_s1)
        predictie_s1 = bacon_s1.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        s1_unsc = sc_s1.inverse_transform(predictie_s1)
        self.temps1.setText(str(s1_unsc))
        
        pickle_soba = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\svr_soba.pickle', 'rb')
        bacon_soba = pickle.load(pickle_soba)
        predictie_soba = bacon_soba.predict(sc_x_aer.transform(np.array([amine, sws, gn]).reshape(1, 3)))
        soba_unsc = sc_soba.inverse_transform(predictie_soba)
        self.tempsoba.setText(str(soba_unsc))
                
        pickle_scor = open('C:\\Users\\timewaster2.0\\OneDrive\\Desktop\\pentru piton\\try4.1\\li_svr.pickle', 'rb')
        bacon_scor = pickle.load(pickle_scor)
        a,b,c,d,e,f = bacon_scor
        self.scoraer.setText(str(a))
        self.scorpres.setText(str(b))
